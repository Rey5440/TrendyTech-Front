                    ...
                    order.status && (
                        <Card key={product.id} style={{ marginBottom: '20px' }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={3} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                    <Typography variant="body2" color="textSecondary">
                                        Precio: ${product.price}
                                    </Typography>
                                    <Button onClick={() => handleOpenDialog(product.id)} variant="contained" color="primary">
                                        Agregar reseña
                                    </Button>
                                </Grid>
                            </Grid>
